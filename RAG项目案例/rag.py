...
class RagService(object):
    ...
    def __init__(self):
        ...
        self.prompt_template = ChatPromptTemplate.from_messages(
            [
                ("system", "以为提供的已知参考资料为主，简洁和专业的回答用户问题。参考资料：{context}"),
    ...
    def __get_chain(self):
        ...
        def format_for_retrirver(value: dict) -> str:
        ...
        chain = (
            {
                ...
                "context": RunnableLambda(format_for_retrirver) | retriver | format_document
...
if __name__ == '__main__':
    ...
    res = RagService().chain.invoke({"input":"春天适合穿什么衣服"}, session_config)
    print(res)